...
#define CONFIG_CANOPEN_RXPDO3_MAPPING5_MAIN_INDEX	ICU_TILT_REQ2_INDEX
#define CONFIG_CANOPEN_RXPDO3_MAPPING5_SUB_INDEX	ICU_TILT_REQ2_SUBINDEX
...
#define CONFIG_CANOPEN_RXPDO7_MAPPING7_MAIN_INDEX	ICU_HCU_INDEX_OFFSET + HCU_PRESSURE_INDEX
