...
#define CONFIG_CANOPEN_RXPDO4_MAPPING5_LEN			CANOPEN_TYPE_LEN(KEYP_BUTTON5_TYPE)
...
#define CONFIG_CANOPEN_RXPDO4_MAPPING7_MAIN_INDEX	ICU_TILT_REQ_INDEX
#define CONFIG_CANOPEN_RXPDO4_MAPPING7_SUB_INDEX	ICU_TILT_REQ_SUBINDEX
